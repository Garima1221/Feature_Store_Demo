...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-science&org_id=3029461491600602&notebook=%2F03_Feature_store_expert&demo_name=feature-store&event=VIEW&path=%2F_dbdemos%2Fdata-science%2Ffeature-store%2F03_Feature_store_expert&version=1">
...
# MAGIC %md
# MAGIC ## Publish feature tables as Databricks-managed online tables
# MAGIC
...
# MAGIC %md
# MAGIC # Optional: Deploy our Function as Feature Spec to compute transformations in realtime
# MAGIC
